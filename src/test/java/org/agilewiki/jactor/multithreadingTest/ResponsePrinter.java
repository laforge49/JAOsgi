...
public class ResponsePrinter extends JLPCActor {
    ...
    public void printResponse(RequestBase wrappedRequest, Actor actor, final ResponseProcessor rp) throws Exception {
        wrappedRequest.send(this, actor, new ResponseProcessor() {
            @Override
