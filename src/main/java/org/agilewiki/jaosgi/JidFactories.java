...
final public class JidFactories extends LocateLocalActorFactories {
    ...
    public void configure(FactoryLocator factoryLocator) throws Exception {
        ...
        factoryLocator.registerActorFactory(new ListJidFactory(ACTOR_LIST_JID_TYPE, new ActorJidFactory()));
        factoryLocator.registerActorFactory(new ListJidFactory(LONG_LIST_JID_TYPE, new LongJidFactory()));
        factoryLocator.registerActorFactory(new ListJidFactory(INTEGER_LIST_JID_TYPE, new IntegerJidFactory()));
        factoryLocator.registerActorFactory(new ListJidFactory(FLOAT_LIST_JID_TYPE, new FloatJidFactory()));
        factoryLocator.registerActorFactory(new ListJidFactory(DOUBLE_LIST_JID_TYPE, new DoubleJidFactory()));
        factoryLocator.registerActorFactory(new ListJidFactory(BOOLEAN_LIST_JID_TYPE, new BooleanJidFactory()));

        factoryLocator.registerActorFactory(new StringMapJidFactory(STRING_STRING_MAP_JID_TYPE, new StringJidFactory()));
        factoryLocator.registerActorFactory(new StringMapJidFactory(STRING_BYTES_MAP_JID_TYPE, new BytesJidFactory()));
        factoryLocator.registerActorFactory(new StringMapJidFactory(STRING_ACTOR_MAP_JID_TYPE, new ActorJidFactory()));
        factoryLocator.registerActorFactory(new StringMapJidFactory(STRING_LONG_MAP_JID_TYPE, new LongJidFactory()));
        factoryLocator.registerActorFactory(new StringMapJidFactory(STRING_INTEGER_MAP_JID_TYPE, new IntegerJidFactory()));
        factoryLocator.registerActorFactory(new StringMapJidFactory(STRING_FLOAT_MAP_JID_TYPE, new FloatJidFactory()));
        factoryLocator.registerActorFactory(new StringMapJidFactory(STRING_DOUBLE_MAP_JID_TYPE, new DoubleJidFactory()));
        factoryLocator.registerActorFactory(new StringMapJidFactory(STRING_BOOLEAN_MAP_JID_TYPE, new BooleanJidFactory()));

        factoryLocator.registerActorFactory(new IntegerMapJidFactory(INTEGER_STRING_MAP_JID_TYPE, new StringJidFactory()));
        factoryLocator.registerActorFactory(new IntegerMapJidFactory(INTEGER_BYTES_MAP_JID_TYPE, new BytesJidFactory()));
        factoryLocator.registerActorFactory(new IntegerMapJidFactory(INTEGER_ACTOR_MAP_JID_TYPE, new ActorJidFactory()));
        factoryLocator.registerActorFactory(new IntegerMapJidFactory(INTEGER_LONG_MAP_JID_TYPE, new LongJidFactory()));
        factoryLocator.registerActorFactory(new IntegerMapJidFactory(INTEGER_INTEGER_MAP_JID_TYPE, new IntegerJidFactory()));
        factoryLocator.registerActorFactory(new IntegerMapJidFactory(INTEGER_FLOAT_MAP_JID_TYPE, new FloatJidFactory()));
        factoryLocator.registerActorFactory(new IntegerMapJidFactory(INTEGER_DOUBLE_MAP_JID_TYPE, new DoubleJidFactory()));
        factoryLocator.registerActorFactory(new IntegerMapJidFactory(INTEGER_BOOLEAN_MAP_JID_TYPE, new BooleanJidFactory()));

        factoryLocator.registerActorFactory(new LongMapJidFactory(LONG_STRING_MAP_JID_TYPE, new StringJidFactory()));
        factoryLocator.registerActorFactory(new LongMapJidFactory(LONG_BYTES_MAP_JID_TYPE, new BytesJidFactory()));
        factoryLocator.registerActorFactory(new LongMapJidFactory(LONG_ACTOR_MAP_JID_TYPE, new ActorJidFactory()));
        factoryLocator.registerActorFactory(new LongMapJidFactory(LONG_LONG_MAP_JID_TYPE, new LongJidFactory()));
        factoryLocator.registerActorFactory(new LongMapJidFactory(LONG_INTEGER_MAP_JID_TYPE, new IntegerJidFactory()));
        factoryLocator.registerActorFactory(new LongMapJidFactory(LONG_FLOAT_MAP_JID_TYPE, new FloatJidFactory()));
        factoryLocator.registerActorFactory(new LongMapJidFactory(LONG_DOUBLE_MAP_JID_TYPE, new DoubleJidFactory()));
        factoryLocator.registerActorFactory(new LongMapJidFactory(LONG_BOOLEAN_MAP_JID_TYPE, new BooleanJidFactory()));

        factoryLocator.registerActorFactory(new StringBMapJidFactory(STRING_STRING_BMAP_JID_TYPE, new StringJidFactory()));
        factoryLocator.registerActorFactory(new StringBMapJidFactory(STRING_BYTES_BMAP_JID_TYPE, new BytesJidFactory()));
        factoryLocator.registerActorFactory(new StringBMapJidFactory(STRING_ACTOR_BMAP_JID_TYPE, new ActorJidFactory()));
        factoryLocator.registerActorFactory(new StringBMapJidFactory(STRING_LONG_BMAP_JID_TYPE, new LongJidFactory()));
        factoryLocator.registerActorFactory(new StringBMapJidFactory(STRING_INTEGER_BMAP_JID_TYPE, new IntegerJidFactory()));
        factoryLocator.registerActorFactory(new StringBMapJidFactory(STRING_FLOAT_BMAP_JID_TYPE, new FloatJidFactory()));
        factoryLocator.registerActorFactory(new StringBMapJidFactory(STRING_DOUBLE_BMAP_JID_TYPE, new DoubleJidFactory()));
        factoryLocator.registerActorFactory(new StringBMapJidFactory(STRING_BOOLEAN_BMAP_JID_TYPE, new BooleanJidFactory()));

        factoryLocator.registerActorFactory(new IntegerBMapJidFactory(INTEGER_STRING_BMAP_JID_TYPE, new StringJidFactory()));
        factoryLocator.registerActorFactory(new IntegerBMapJidFactory(INTEGER_BYTES_BMAP_JID_TYPE, new BytesJidFactory()));
        factoryLocator.registerActorFactory(new IntegerBMapJidFactory(INTEGER_ACTOR_BMAP_JID_TYPE, new ActorJidFactory()));
        factoryLocator.registerActorFactory(new IntegerBMapJidFactory(INTEGER_LONG_BMAP_JID_TYPE, new LongJidFactory()));
        factoryLocator.registerActorFactory(new IntegerBMapJidFactory(INTEGER_INTEGER_BMAP_JID_TYPE, new IntegerJidFactory()));
        factoryLocator.registerActorFactory(new IntegerBMapJidFactory(INTEGER_FLOAT_BMAP_JID_TYPE, new FloatJidFactory()));
        factoryLocator.registerActorFactory(new IntegerBMapJidFactory(INTEGER_DOUBLE_BMAP_JID_TYPE, new DoubleJidFactory()));
        factoryLocator.registerActorFactory(new IntegerBMapJidFactory(INTEGER_BOOLEAN_BMAP_JID_TYPE, new BooleanJidFactory()));

        factoryLocator.registerActorFactory(new LongBMapJidFactory(LONG_STRING_BMAP_JID_TYPE, new StringJidFactory()));
        factoryLocator.registerActorFactory(new LongBMapJidFactory(LONG_BYTES_BMAP_JID_TYPE, new BytesJidFactory()));
        factoryLocator.registerActorFactory(new LongBMapJidFactory(LONG_ACTOR_BMAP_JID_TYPE, new ActorJidFactory()));
        factoryLocator.registerActorFactory(new LongBMapJidFactory(LONG_LONG_BMAP_JID_TYPE, new LongJidFactory()));
        factoryLocator.registerActorFactory(new LongBMapJidFactory(LONG_INTEGER_BMAP_JID_TYPE, new IntegerJidFactory()));
        factoryLocator.registerActorFactory(new LongBMapJidFactory(LONG_FLOAT_BMAP_JID_TYPE, new FloatJidFactory()));
        factoryLocator.registerActorFactory(new LongBMapJidFactory(LONG_DOUBLE_BMAP_JID_TYPE, new DoubleJidFactory()));
        factoryLocator.registerActorFactory(new LongBMapJidFactory(LONG_BOOLEAN_BMAP_JID_TYPE, new BooleanJidFactory()));
    }
}
