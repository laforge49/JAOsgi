...
final public class JidFactories extends LocateLocalActorFactories {
    ...
    public void configure(FactoryLocator factoryLocator) throws Exception {
        ...
        factoryLocator.registerActorFactory(new ListJidFactory(STRING_LIST_JID_TYPE, STRING_JID_TYPE));
        factoryLocator.registerActorFactory(new ListJidFactory(BYTES_LIST_JID_TYPE, BYTES_JID_TYPE));
        factoryLocator.registerActorFactory(new ListJidFactory(ACTOR_LIST_JID_TYPE, ACTOR_JID_TYPE));
        factoryLocator.registerActorFactory(new ListJidFactory(LONG_LIST_JID_TYPE, LONG_JID_TYPE));
        factoryLocator.registerActorFactory(new ListJidFactory(INTEGER_LIST_JID_TYPE, INTEGER_JID_TYPE));
        factoryLocator.registerActorFactory(new ListJidFactory(FLOAT_LIST_JID_TYPE, FLOAT_JID_TYPE));
        factoryLocator.registerActorFactory(new ListJidFactory(DOUBLE_LIST_JID_TYPE, DOUBLE_JID_TYPE));
        factoryLocator.registerActorFactory(new ListJidFactory(BOOLEAN_LIST_JID_TYPE, BOOLEAN_JID_TYPE));

        factoryLocator.registerActorFactory(new StringMapJidFactory(STRING_STRING_MAP_JID_TYPE, STRING_JID_TYPE));
        factoryLocator.registerActorFactory(new StringMapJidFactory(STRING_BYTES_MAP_JID_TYPE, BYTES_JID_TYPE));
        factoryLocator.registerActorFactory(new StringMapJidFactory(STRING_ACTOR_MAP_JID_TYPE, ACTOR_JID_TYPE));
        factoryLocator.registerActorFactory(new StringMapJidFactory(STRING_LONG_MAP_JID_TYPE, LONG_JID_TYPE));
        factoryLocator.registerActorFactory(new StringMapJidFactory(STRING_INTEGER_MAP_JID_TYPE, INTEGER_JID_TYPE));
        factoryLocator.registerActorFactory(new StringMapJidFactory(STRING_FLOAT_MAP_JID_TYPE, FLOAT_JID_TYPE));
        factoryLocator.registerActorFactory(new StringMapJidFactory(STRING_DOUBLE_MAP_JID_TYPE, DOUBLE_JID_TYPE));
        factoryLocator.registerActorFactory(new StringMapJidFactory(STRING_BOOLEAN_MAP_JID_TYPE, BOOLEAN_JID_TYPE));

        factoryLocator.registerActorFactory(new IntegerMapJidFactory(INTEGER_STRING_MAP_JID_TYPE, STRING_JID_TYPE));
        factoryLocator.registerActorFactory(new IntegerMapJidFactory(INTEGER_BYTES_MAP_JID_TYPE, BYTES_JID_TYPE));
        factoryLocator.registerActorFactory(new IntegerMapJidFactory(INTEGER_ACTOR_MAP_JID_TYPE, ACTOR_JID_TYPE));
        factoryLocator.registerActorFactory(new IntegerMapJidFactory(INTEGER_LONG_MAP_JID_TYPE, LONG_JID_TYPE));
        factoryLocator.registerActorFactory(new IntegerMapJidFactory(INTEGER_INTEGER_MAP_JID_TYPE, INTEGER_JID_TYPE));
        factoryLocator.registerActorFactory(new IntegerMapJidFactory(INTEGER_FLOAT_MAP_JID_TYPE, FLOAT_JID_TYPE));
        factoryLocator.registerActorFactory(new IntegerMapJidFactory(INTEGER_DOUBLE_MAP_JID_TYPE, DOUBLE_JID_TYPE));
        factoryLocator.registerActorFactory(new IntegerMapJidFactory(INTEGER_BOOLEAN_MAP_JID_TYPE, BOOLEAN_JID_TYPE));

        factoryLocator.registerActorFactory(new LongMapJidFactory(LONG_STRING_MAP_JID_TYPE, STRING_JID_TYPE));
        factoryLocator.registerActorFactory(new LongMapJidFactory(LONG_BYTES_MAP_JID_TYPE, BYTES_JID_TYPE));
        factoryLocator.registerActorFactory(new LongMapJidFactory(LONG_ACTOR_MAP_JID_TYPE, ACTOR_JID_TYPE));
        factoryLocator.registerActorFactory(new LongMapJidFactory(LONG_LONG_MAP_JID_TYPE, LONG_JID_TYPE));
        factoryLocator.registerActorFactory(new LongMapJidFactory(LONG_INTEGER_MAP_JID_TYPE, INTEGER_JID_TYPE));
        factoryLocator.registerActorFactory(new LongMapJidFactory(LONG_FLOAT_MAP_JID_TYPE, FLOAT_JID_TYPE));
        factoryLocator.registerActorFactory(new LongMapJidFactory(LONG_DOUBLE_MAP_JID_TYPE, DOUBLE_JID_TYPE));
        factoryLocator.registerActorFactory(new LongMapJidFactory(LONG_BOOLEAN_MAP_JID_TYPE, BOOLEAN_JID_TYPE));

        factoryLocator.registerActorFactory(new StringBMapJidFactory(STRING_STRING_BMAP_JID_TYPE, STRING_JID_TYPE));
        factoryLocator.registerActorFactory(new StringBMapJidFactory(STRING_BYTES_BMAP_JID_TYPE, BYTES_JID_TYPE));
        factoryLocator.registerActorFactory(new StringBMapJidFactory(STRING_ACTOR_BMAP_JID_TYPE, ACTOR_JID_TYPE));
        factoryLocator.registerActorFactory(new StringBMapJidFactory(STRING_LONG_BMAP_JID_TYPE, LONG_JID_TYPE));
        factoryLocator.registerActorFactory(new StringBMapJidFactory(STRING_INTEGER_BMAP_JID_TYPE, INTEGER_JID_TYPE));
        factoryLocator.registerActorFactory(new StringBMapJidFactory(STRING_FLOAT_BMAP_JID_TYPE, FLOAT_JID_TYPE));
        factoryLocator.registerActorFactory(new StringBMapJidFactory(STRING_DOUBLE_BMAP_JID_TYPE, DOUBLE_JID_TYPE));
        factoryLocator.registerActorFactory(new StringBMapJidFactory(STRING_BOOLEAN_BMAP_JID_TYPE, BOOLEAN_JID_TYPE));

        factoryLocator.registerActorFactory(new IntegerBMapJidFactory(INTEGER_STRING_BMAP_JID_TYPE, STRING_JID_TYPE));
        factoryLocator.registerActorFactory(new IntegerBMapJidFactory(INTEGER_BYTES_BMAP_JID_TYPE, BYTES_JID_TYPE));
        factoryLocator.registerActorFactory(new IntegerBMapJidFactory(INTEGER_ACTOR_BMAP_JID_TYPE, ACTOR_JID_TYPE));
        factoryLocator.registerActorFactory(new IntegerBMapJidFactory(INTEGER_LONG_BMAP_JID_TYPE, LONG_JID_TYPE));
        factoryLocator.registerActorFactory(new IntegerBMapJidFactory(INTEGER_INTEGER_BMAP_JID_TYPE, INTEGER_JID_TYPE));
        factoryLocator.registerActorFactory(new IntegerBMapJidFactory(INTEGER_FLOAT_BMAP_JID_TYPE, FLOAT_JID_TYPE));
        factoryLocator.registerActorFactory(new IntegerBMapJidFactory(INTEGER_DOUBLE_BMAP_JID_TYPE, DOUBLE_JID_TYPE));
        factoryLocator.registerActorFactory(new IntegerBMapJidFactory(INTEGER_BOOLEAN_BMAP_JID_TYPE, BOOLEAN_JID_TYPE));

        factoryLocator.registerActorFactory(new LongBMapJidFactory(LONG_STRING_BMAP_JID_TYPE, STRING_JID_TYPE));
        factoryLocator.registerActorFactory(new LongBMapJidFactory(LONG_BYTES_BMAP_JID_TYPE, BYTES_JID_TYPE));
        factoryLocator.registerActorFactory(new LongBMapJidFactory(LONG_ACTOR_BMAP_JID_TYPE, ACTOR_JID_TYPE));
        factoryLocator.registerActorFactory(new LongBMapJidFactory(LONG_LONG_BMAP_JID_TYPE, LONG_JID_TYPE));
        factoryLocator.registerActorFactory(new LongBMapJidFactory(LONG_INTEGER_BMAP_JID_TYPE, INTEGER_JID_TYPE));
        factoryLocator.registerActorFactory(new LongBMapJidFactory(LONG_FLOAT_BMAP_JID_TYPE, FLOAT_JID_TYPE));
        factoryLocator.registerActorFactory(new LongBMapJidFactory(LONG_DOUBLE_BMAP_JID_TYPE, DOUBLE_JID_TYPE));
        factoryLocator.registerActorFactory(new LongBMapJidFactory(LONG_BOOLEAN_BMAP_JID_TYPE, BOOLEAN_JID_TYPE));
    }
}
